...
async function initHomeMarketplacePreview() {
    ...
    container.innerHTML = preview.map(p => {
        ...
        return `
        <div class="col-sm-6 col-md-4 col-lg-3" data-product-id="${p.id}">
                ...
                <div class="card product-card border-0 h-100 shadow-sm">
                    ...
                    <div class="card-body p-3 d-flex flex-column justify-content-between">
                        ...
                        <div class="mt-3">
                            <div class="d-flex align-items-center justify-content-between gap-2">
                                <span class="product-price fw-bold">${p.priceDisplay}</span>
                                <button class="btn btn-orange btn-sm rounded-2 px-3 fw-medium" title="Add to Cart" onclick='Cart.add(${cartPayload})'>
